...
async def home(client, message):
  buttons = [[
    ...
    [
        InlineKeyboardButton('Our Channel', url='http://telegram.me/SLBotOfficial'),
        InlineKeyboardButton('Source Code', url='https://github.com/DARKEMPIRESL/Telegraph-Uploader')
    ],
    [
        InlineKeyboardButton('OWNER', url='https://t.me/SL_BOTS_TM')
    ]]
...
Made By [𝕯𝖆𝖗𝖐 𝕰𝖒𝖕𝖎𝖗𝖊](https://t.me/SL_BOTS_TM)</b>""",
